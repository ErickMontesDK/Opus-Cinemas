...
export const handler = async (event) => {
    ...
    // 🔍 DEBUG: Log entire event to see what's coming in
    console.log('=== SHOWTIMES HANDLER DEBUG ===');
    ...
    try {
        ...
        switch (httpMethod) {
            case 'GET': {
                ...
                console.log('📋 Extracted params:', { movieId, startDate, startTime, end_time, selectedShowtimeId });
                ...
                if (movieId && startDate && startTime) {
                    ...
                    console.log('✅ Supabase response - data:', showtimes_db);
